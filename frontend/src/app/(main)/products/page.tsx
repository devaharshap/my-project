...
function ProductsContent() {
  ...
  const pageData: PageResponse<Product> = data?.data?.data ?? {
    content: [], totalPages: 0, totalElements: 0,
    pageNumber: 0, pageSize: 12, first: true, last: true,
  }
